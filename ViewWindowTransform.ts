...
//        scaleToVOCompensate = scaleToVOCompensate.scaleNonUniform(this.pxPerSec, 1)
        ...
        if ((this.uMax - this.uMin) < 1e-10) throw new Error("View Window Width is too small")
        if ((this.vMax - this.vMin) < 1e-10) throw new Error("View Window Height is too small")
    ...
    private updateGeneral() {
        ...
        const generalTransform = this.svgTranformList.createSVGTransformFromMatrix(this.GeneralMatrix)
